...
void initMPU9150(void)
{
  ...
  MPU6050_WriteReg(MPU6050_RA_SMPLRT_DIV , 39);     // sampling rate (200Hz) (8000 / 200 = 40)
...
//  setMPU6050ClockSource(MPU6050_PWR1_CLKSEL_BIT, MPU6050_CLOCK_PLL_EXT32K); // set clock source (internal oscillator is the default)
}
