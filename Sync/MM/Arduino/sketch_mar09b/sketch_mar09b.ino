...
void setup() {
  ...
  pinMode(HDG204_CS, OUTPUT);
  digitalWrite(HDG204_CS, LOW);
...
//  pinMode(SD_CS, OUTPUT);
  ...
  Serial.println("SPI Interface Established");
...
{  
  ...
  Serial.print(MAX_FIFO_SIZE);
  Serial.println("");
  Serial.println("writing data to the SD !");
